...
from utils import load_model, load_prompt, set_memory, initialize_chain, generate_message # dotString 사용 후 설명 까지 보여줄 수 있음
...
if st.session_state.chat_started:
    ...
    if prompt :=st.chat_input():
        ...
        with st.chat_message("assistant"):
            ...
            message_placeholder.markdown(full_response.strip())  # 최종 응답 표시 맨마지막 커서 안보이게 하는 것
